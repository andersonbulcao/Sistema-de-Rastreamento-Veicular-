...
import { Settings as SettingsIcon, User, Bell, Map, Shield, Database, Smartphone } from 'lucide-react';
            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    defaultValue="TrackVeículos Ltda"
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                  <div>
                    <h4 className="text-sm font-medium text-gray-900">Alertas de Velocidade</h4>
                    <p className="text-sm text-gray-600">Notificar quando veículos excedem o limite</p>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                  <div>
                    <h4 className="text-sm font-medium text-gray-900">Alertas de Manutenção</h4>
                    <p className="text-sm text-gray-600">Notificar sobre vencimento de manutenções</p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" defaultChecked className="sr-only peer" />
                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                ...
                <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                  <div>
                    <h4 className="text-sm font-medium text-gray-900">Notificações Email</h4>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Maior segurança para acesso ao sistema</p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" className="sr-only peer" />
                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
      ...
      default:
        return (
          <div className="text-center py-8">
            ...
            <p className="text-gray-500">Configurações de {tabs.find(t => t.id === activeTab)?.label}</p>
          </div>
        );
    }
  };
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Gerencie as configurações do sistema de rastreamento</p>
      </div>
