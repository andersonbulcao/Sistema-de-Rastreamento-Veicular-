...
interface ClientRecentAlertsProps {
  user: User;
}

export function ClientRecentAlerts({ user }: ClientRecentAlertsProps) {
  const allAlerts = [
    {
      id: 1,
      type: 'speed',
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200">
      <div className="p-4 border-b border-gray-200">
        ...
        <p className="text-sm text-gray-600">Últimas notificações dos seus veículos</p>
      </div>
